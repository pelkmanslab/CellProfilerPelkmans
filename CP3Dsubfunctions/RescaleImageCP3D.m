...
% Rescale image
RescaledImage = -(double(Image)-double(minRescInt))./(double(maxRescInt)-double(minRescInt));  % note that here rescaling is not normalized to max of 100%=1 as in initial Identifyprimlog2
