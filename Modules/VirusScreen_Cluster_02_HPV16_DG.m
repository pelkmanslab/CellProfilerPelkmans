function handles = VirusScreen_Cluster_02_HPV16_DG(handles)
...
%%%VariableRevisionNumber = 1
    ...
    intSDsForThreshold = 1;
    if intSetBeingAnalyzed==1
        disp(sprintf('%s: Note, using calculating threshold %d standard deviations from mean',mfilename,intSDsForThreshold))
    end
