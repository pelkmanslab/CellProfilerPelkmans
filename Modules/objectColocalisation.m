function handles = objectColocalisation(handles)


%MatF in Pelkmans Lab, 010911.
%this module is analysing the colocalisation of different objects you
%adress to it.
...
%you'll find this loop all over the code, security check as missing labels
%on the top of the list are not counted by region props.
%ex: if you have objects in cells 1 2 3 8 10, automatically 4 5 6 7 and 9
%get a 0, but let say in that case there is 12 cells, 11 and 12 w/o objects
%are just not taken into account, this is the mess for ratio-ing. So I fix
%this.
...
matSurfaceOfNonoverlappingItem1PerCell = matSurfaceOfNonoverlappingItem1PerCell';
mat_FractionOfremainingObj1 = matSurfaceOfNonoverlappingItem1PerCell ./ matSurfaceOfItem1PerCell;
end
...
matSurfaceOfNonoverlappingItem2PerCell = matSurfaceOfNonoverlappingItem2PerCell';
mat_FractionOfremainingObj2 = matSurfaceOfNonoverlappingItem2PerCell ./ matSurfaceOfItem2PerCell;
end
...
matSurfaceOfNonoverlappingItem1_overlappingWithObject3_PerCell = matSurfaceOfNonoverlappingItem1_overlappingWithObject3_PerCell';    
mat_FractionOfremainingObj1__OccupiedPerObject3 = matSurfaceOfNonoverlappingItem1_overlappingWithObject3_PerCell ./ matSurfaceOfNonoverlappingItem1PerCell;
end
...
matSurfaceOfNonoverlappingItem2_overlappingWithObject3_PerCell = matSurfaceOfNonoverlappingItem2_overlappingWithObject3_PerCell';    
mat_FractionOfremainingObj2__OccupiedPerObject3 = matSurfaceOfNonoverlappingItem2_overlappingWithObject3_PerCell ./ matSurfaceOfNonoverlappingItem2PerCell;
end
