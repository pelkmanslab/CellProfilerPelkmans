...
%textVAR18 = If using ORDER, how many images are there in each group (i.e. each field of view)?
%defaultVAR18 = 3
ImagesPerSet = str2double(char(handles.Settings.VariableValues{CurrentModuleNum,18}));

%textVAR19 = Are you loading image or movie files?
%choiceVAR19 = Image
%choiceVAR19 = Movie
ImageOrMovie = char(handles.Settings.VariableValues{CurrentModuleNum,19});
%inputtypeVAR19 = popupmenu

%textVAR20 = If you are loading a movie, what is the extension?
%choiceVAR20 = avi
%choiceVAR20 = stk
FileFormat = char(handles.Settings.VariableValues{CurrentModuleNum,20});
%inputtypeVAR20 = popupmenu

%textVAR21 = Analyze all subfolders within the selected folder?
%choiceVAR21 = No
%choiceVAR21 = Yes
AnalyzeSubDir = char(handles.Settings.VariableValues{CurrentModuleNum,21});
%inputtypeVAR21 = popupmenu

%pathnametextVAR22 = Enter the path name to the folder where the images to be loaded are located. Type period (.) for default image folder.
Pathname = char(handles.Settings.VariableValues{CurrentModuleNum,22});
