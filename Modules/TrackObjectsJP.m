...
%textVAR12 = What is the relative overlap of Child on Parent you would like qualify as being related?
%defaultVAR12 = Do not use
%infotypeVAR12 = imagegroup indep
OverlapFactorP = char(handles.Settings.VariableValues{CurrentModuleNum,12});
...
%if a parent has no child

CurrentLabels=CurrentObjList;


CurrentHeaders=ParentsMatrix;
