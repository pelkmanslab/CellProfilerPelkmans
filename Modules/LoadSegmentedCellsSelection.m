function handles = LoadSegmentedCellsSelection(handles)
...
% In contrast to the initial module, the channel, which forms the base of
% the file name of the segmentation can be specified (in case objects are
