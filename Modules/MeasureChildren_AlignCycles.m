function handles = MeasureChildren_AlignCycles(handles)
...
for i = 1:length(AllFeatures)
    ...
    nameMeasurementNaNMean=     ['NaNMeanOf'    AllFeatures{i} 'Of' SubObjectName];
    nameMeasurementNaNMedian =  ['NaNMedianOf'  AllFeatures{i} 'Of' SubObjectName];
    nameMeasurementNaNVar =     ['NaNVarOf'     AllFeatures{i} 'Of' SubObjectName];
    nameMeasurementNaNMom3 =    ['NaNMom3Of'    AllFeatures{i} 'Of' SubObjectName];
    nameMeasurementNaNMom4 =    ['NaNMom4Of'    AllFeatures{i} 'Of' SubObjectName];
    nameMeasurementNaNMom5 =    ['NaNMom5Of'    AllFeatures{i} 'Of' SubObjectName];
    nameMeasurementNaNMom6 =    ['NaNMom6Of'    AllFeatures{i} 'Of' SubObjectName];
    nameMeasurementNaNStd =     ['NaNStdOf'     AllFeatures{i} 'Of' SubObjectName];
