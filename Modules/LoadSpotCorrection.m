function handles = LoadSpotCorrection(handles)

% Help for the Load Spot Correction module:
...
%pathnametextVAR02 = Enter the path name to the folder where the Spot Correction to be loaded is located.  Type period (.) for the default image folder.
Pathname = char(handles.Settings.VariableValues{CurrentModuleNum,2});

%filenametextVAR03 = What is the name of the Spot Correction file (.mat)? 
