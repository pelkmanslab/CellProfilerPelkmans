...
%defaultVAR11 = 80
max_shift = handles.Settings.VariableValues{CurrentModuleNum,11};

%textVAR12 = How many time should we try to align the images?
%defaultVAR12 = 5
max_iterations = handles.Settings.VariableValues{CurrentModuleNum,12};
...
for ix = 1:num_cycles
    [NSWE_Cis(ix,:), NSWE_Trans(ix,:)] = getRobustAlignmentAtLowIntensity(RefCycleImage, RefImage{ix}, max_iterations, max_iterations);
end
