...
% Before you run the dependency check,
% clear your path and then only add the path to the local copies of
% - 'CellProfilerPelkmans'
% - 'PelkmansLibrary'
% repositories.
fprintf('. Restoring default Matlab path\n')
restoredefaultpath;
fprintf('. Defining locations of repositories and setting up Matlab path for dependency checks\n')
...
output_file = fullfile(tempname, 'CPmodule_dep.json');
fprintf('. List of module dependencies will be written to the follwing file:\n%s\n', output_file)
