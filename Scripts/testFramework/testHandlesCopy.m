function [ handles ] = testHandlesCopy( subFolderPath, handlesName, pathOld, pathNew, testCase )
...
% paths
    ...
    handles = testHandlesRewrite( subFolderPath, handlesName, pathOld, temporaryFolder );
end
